...
function ClassicRoomDetails() {
    ...
    useEffect(() => {
        const load = async () => {
            try {
                ...
                setRooms(data.filter((r) => r.roomType?.toLowerCase() === "classic"));
            } catch (e) {
                console.error(e);
            } finally {
                setLoading(false);
    ...
    const handleReserve = (room) => {
        ...
        navigate(`/rooms/classic/${slug}/booking`, {
            state: { room: { ...room, roomType: "classic", beds: getBedText(room.amenities) } },
        });
    };
            ...
            <div className="min-h-screen bg-gray-50 pt-24 pb-16 px-4">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-gray-900">Classic Rooms</h1>
                    ...
                    {!loading && rooms.length === 0 && (
                        <p className="text-gray-400 text-center py-16">No Classic rooms available.</p>
                    )}
